...
<article id="pop-news">
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-7 col-12" id="featured">
                    ...
                    @php    $i=1    @endphp
                     ...
                     @foreach ($latestPosts as $post)
                        <div
                            ...
                            @endif
                             >
                                <img src='http://localhost/UiT_News/Backend/UiTNews/file/post/{{$post->POST_IMAGE}}' class="d-block w-100">
                                <div class="carousel-caption ">
            ...
            <div id="picked" class="row ">
                ...
                @foreach ($post_sk as $post)
                    <div class="col-md-4">
                        <div class="card">
                            <img class="card-img-top"  src='http://localhost/UiT_News/Backend/UiTNews/file/post/{{$post->POST_IMAGE}}' alt="Card image">
                            <div class="card-body">
        ...
        <div class="col-md-5 " id="latest">
            ...
            <div class="slot1">
                <img  src='http://localhost/UiT_News/Backend/UiTNews/file/post/{{$post->POST_IMAGE}}' >
            ...
            <div class="left-board clearfix">
                <div class="news-roller">
                    @foreach ($post_tt as $post)
                            <div class="slot1">
                                <img style="width: 300px;" src='http://localhost/UiT_News/Backend/UiTNews/file/post/{{$post->POST_IMAGE}}' >
                                <a href="{{ route('postdetail.show',$post->id ) }}"><strong>  {{$post->POST_TITLE}}</strong></a>
                                <p class="content"id="hidden"> {{$post->POST_DESCRIPT }}</p>
                                {{-- <p class="type">{{ $type->TYPE_NAME }}</p> --}}
                                {{-- <p class="time" > {{ date_format($post->created_at,"d/m/Y H:i:s") }}   </p> --}}
